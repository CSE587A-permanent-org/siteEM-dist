...
from siteEM.utils.bailey_elkan_hacks import \
    normalize_posterior_row, update_eraser_row
from siteEM.utils import read_in_fasta, nucleotide_count
...
def e_step(sequence: List[int],
    ...
    # YOUR CODE GOES HERE. Comment out the error above.
...
def update_motif_prior(posteriors: List[NDArray[np.float64]]) -> float:
    ...
    # YOUR CODE GOES HERE. Comment out the error code below.
    raise NotImplementedError("Implementing this is part of the assignment.")
